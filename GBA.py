...
# ================= general ================= #
CFG.DESCRIPTION = "(GBA) configuration"
CFG.RUNNER = CMHRunner
...
CFG.MODEL.NAME = "CMH"
CFG.MODEL.ARCH = CMH
adj_path = "datasets/" + CFG.DATASET_NAME + "/gba_rn_adj.npy"
...
CFG.MODEL.PARAM = {
    ...
    "pre_trained_tmae_path": "mask_save/TMAE_SD_864.pt",
    "pre_trained_smae_path": "mask_save",
    "mask_args": {
                    "patch_size":12,
                    "in_channel":1,
                    "embed_dim":96,
